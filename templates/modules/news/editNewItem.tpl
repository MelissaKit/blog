    ...
    <div class="jumbotron review-container">
        <div class="row">
            ...
            <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                <form class="form" method="post" action="/News/Edit/?Id=<?php echo $Params['Id'];?>" enctype="multipart/form-data">
                    <?php echo "<p><span class='fa fa-film  fa-review'> Назва</span><input type='text' name='title' id='title' title='0-100 символів' pattern='.{0,100}'
                                                                                           class='form-control' value='".$Params['Title']."'/></p>
                    <p><span class='fa fa fa-sticky-note-o fa-review'> Текст</span><textarea name='content' id='content'
                                                                                             class='form-control textarea-item'>".$Params['Content']."</textarea>
                    </p>";?>
