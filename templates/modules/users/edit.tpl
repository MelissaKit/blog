        ...
        <div class="row">
                ...
                <form  method="post" action="/Users/ChangePass/">
                    <p>Змінити пароль</p>
                        <div class="form-group">
                            <input type="password" name="password" id="password" class="form-control required"   pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{0,60}" title="Має містити символи різних регістрів та як мінімум 6 символів"
                                   placeholder="Старий пароль">
                        </div>
                        <div class="form-group">
                            <input type="password" name="passwordNew" id="passwordNew"
                                   class="form-control required" placeholder="Новий пароль">
                        </div>
                    <div class="prof-but">
            ...
            <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                ...
                <ul class="container details edit-block">
                    ...
                    echo "<li><p><span class='glyphicon glyphicon-picture prof-icon'></span>Аватар</p>
                        <input type='file' name='avatar' id='imageUpload' class='hide img-input form-control-file'/>
                        <label for='imageUpload' class='btn btn-large custom-file-label '>Змінити фото профіля</label>
