    ...
    <div class="jumbotron review-container">
        <div class="row">
            <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8 review-adding">
                <form class="form" method="post" action="/Main/Add/" enctype="multipart/form-data">
                    <p><span class='fa fa-film  fa-review'> Назва</span><input type='text' name='name' id='name'  pattern=".{0,50}" title="2-50 символів"
                                                                               class='form-control'/></p>
                    <p><span class='fa fa-globe fa-review'> Країна</span><input type='text' name='country' id='country'pattern=".{0,40}" title="2-40 символів"
                                                                                class='form-control'/></p>
                    ...
                    <p><span class='fa fa fa-file fa-review'> Постер</span>
                        ...
                        <label for='canAvatar' class='btn btn-large custom-file-label hid-img btn-auto' id='canAvatarLabel'>Скинути</label></p>
